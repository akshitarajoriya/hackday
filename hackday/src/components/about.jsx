  ...
  return (
   <>
    <div>
     ...
     <div> our website provide information on various type of mental health disorders</div>
     <div> we have various therapist connected to help + the AI model is supposed to provide therapy sessions based on your specific disorders</div>
